...
class Uncom extends Component {
    ...
    render() {
        ...
        // console.log('Hierher schauen', activities)
        // console.log('Hierher schauen2', employees)
        // console.log('Hierher schauen3', plannedTimes)
        // console.log('Hierher schauen4', bookedTimes)
