      ...
      <Dialog open={this.props.show} onClose = {this.handleClose}>
        ...
        <DialogContent>
          <form onSubmit={this.addActivity}>
            <div>
              <div><TextField type='text'  required fullWidth margin='normal' name='activityName' label='activity name:'  value={activityName} 
               onChange={this.handleChange}
              /></div>
              <div><TextField type='text' required fullWidth margin='normal' name='capacity' label='capacity:' value={capacity}
