...
class FlexDayStartMapper(Mapper):
    ...
    def insert(self, flex_day_start):
        ...
        command = "INSERT INTO worktimeapp.flexdaystart (id, date_of_last_change, date) VALUES (%s, %s,%s)"
        data = (
    ...
    def find_all(self):
        ...
        result = []
        cursor = self._cnx.cursor()
        command = "SELECT id, date_of_last_change, date FROM worktimeapp.flexdaystart"
