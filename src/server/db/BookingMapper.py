...
class BookingMapper (Mapper):
    ...
    def find_all(self):
        ...
        cursor.execute(
            "SELECT id, workTimeAccountId, userId, type from bookings")
    ...
    def find_by_work_time_account_id(self, workTimeAccountId):
        ...
        result = []
        cursor = self._cnx.cursor()
        command = "SELECT id, workTimeAccountId, userId, type FROM bookings WHERE workTimeAccountId={} ORDER BY id".format(
            workTimeAccountId)
    ...
    def find_by_type(self, type):
        ...
        result = []
        cursor = self._cnx.cursor()
        command = "SELECT id, workTimeAccountId, userId, type FROM bookings WHERE type={} ORDER BY id".format(
            type)
        cursor.execute(command)
        tuples = cursor.fetchall()
