...
class BookingMapper (Mapper):
    ...
    def find_all(self):
        ...
        for (id, date_of_last_change, work_time_account_id, user_id, type, event_booking_id, time_interval_booking_id) in tuples:
            booking = BookingBO()
            booking.set_id(id)
            booking.set_date_of_last_change(date_of_last_change)
            booking.set_work_time_account_id(work_time_account_id)
            booking.set_user_id(user_id)
            booking.set_type(type)
            booking.set_event_booking_id(event_booking_id)
            booking.set_time_interval_booking_id(time_interval_booking_id)
    ...
    def find_timeinterval_bookings_by_user_id(self, user_id):
    ...
    def find_event_bookings_by_user_id(self, user_id):
    ...
    def update(self, booking):
        ...
        booking.set_date_of_last_change(time_stamp)
        cursor = self._cnx.cursor()
    ...
    def find_by_key(self, key):
        ...
        try:
            (id, date_of_last_change, work_time_account_id, user_id, type,
             event_booking_id, time_interval_booking_id) = tuples[0]
            booking = BookingBO()
            booking.set_id(id)
            booking.set_date_of_last_change(date_of_last_change)
            booking.set_work_time_account_id(work_time_account_id)
    ...
    def find_booking_by_booking_subclass(self, foreign_key, key, type):
