...
class IllnessMapper(TimeIntervalMapper):
    ...
    def find_all(self):
        ...
        cursor.execute("SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type from worktimeapp.flexdays")
    ...
    def find_by_key(self, key):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type from worktimeapp.flexdays WHERE id={}".format(key)
    ...
    def insert (self, flexday):
        ...
        data = (flexday.get_id(), flexday.get_date_of_last_change(), flexday.get_start(), flexday. get_end(), flexday.get_start_event(), flexday.get_end_event(), "Flex Day")
    ...
    def update (self, flexday):
        ...
        command = "UPDATE worktimeapp.flexdays " + "SET start=%s, end=%s WHERE id=%s"
        data = (flexday.get_start(), flexday.get_end(), flexday.get_id())
        cursor.execute(command, data)
    ...
    def delete(self, flexday):
        ...
        command = "DELETE FROM worktimeapp.flexdays WHERE id={}".format(flexday.get_id())
        cursor.execute(command)
    ...
    def find_by_date(self, date):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type FROM worktimeapp.flexdays WHERE start={}".format(date)
        cursor.execute(command)
        tuples = cursor.fetchall()
    ...
    def find_by_time_period(self, start_date, end_date):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type FROM worktimeapp.flexdays WHERE start>={} AND end<={}".format(start_date, end_date)
        cursor.execute(command)
        tuples = cursor.fetchall()
