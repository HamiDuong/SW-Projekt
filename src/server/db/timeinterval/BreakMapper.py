...
class BreakMapper(TimeIntervalMapper):
    ...
    def find_all(self):
        ...
        cursor.execute("SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type from worktimeapp.breaks")
    ...
    def find_by_key(self, key):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type from worktimeapp.breaks WHERE id={}".format(key)
    ...
    def insert (self, breakobj):
        ...
        data = (breakobj.get_id(), breakobj.get_date_of_last_change(), breakobj.get_start(), breakobj. get_end(), breakobj.get_start_event(), breakobj.get_end_event(), "Break")
    ...
    def find_by_date(self, date):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type FROM worktimeapp.breaks WHERE start={}".format(date)
        cursor.execute(command)
        tuples = cursor.fetchall()
    ...
    def find_by_time_period(self, start_date, end_date):
        ...
        command = "SELECT id, dateOfLastChange, start, end, startEvent, endEvent, type FROM worktimeapp.breaks WHERE start>={} AND end<={}".format(start_date, end_date)
        cursor.execute(command)
        tuples = cursor.fetchall()
