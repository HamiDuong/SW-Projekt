...
class ProjectWorkBO (ti.TimeIntervalBO):
    ...
    geerbte Attribute
        ...
        _start_event: Fremdschlüssel zum ProjectWorkBeginBO (TimeIntervalBO)
        _end_event: Fremdschlüssel zum ProjectWorkEndBO     (TimeIntervalBO)
        _type: Art der Subklasse, hier: "ProjectWork"       (TimeIntervalBO)
    Attribute
        _activity_id: Fremdschlüssel zum ActivityBO
    """
    def __init__(self):
        super().__init__()
