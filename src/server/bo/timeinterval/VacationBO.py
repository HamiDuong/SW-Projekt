...
class VacationBO (ti.TimeIntervalBO):
    ...
    def __str__(self):
        return "Urlaub {}: von {} bis {}, gehört zum Intervall mit der ID {}, Startevent: {}, Endevent: {}".format(self.get_id(), self.get_start(), self.get_end(), self.get_time_interval_id(), self.get_start_event(), self.get_end_event())
