...
class TimeIntervalBO (bo.BusinessObject):
    ...
    def __str__(self):
        return "Timeintervall {}: Startpunkt {}, Endpunkt {}, gehört zur Intervall-Buchung mit der ID {}".format(self.get_id(), self.get_start(), self.get_end(), self.get_time_interval_booking_id())
